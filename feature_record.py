...
def main(args):
    ...
    wandb_name=f'{dataset}_epoches{args.num_epoches}_batchsize{args.batch_size}_lr{args.lr}_wavlength{args.wav_length}_attack_num{args.attack_num}_dropneuro{args.drop_neuro_num}'
